========================================================================
    KONSOLENANWENDUNG: opengleinfuehrung-Projektübersicht
========================================================================

Diese opengleinfuehrung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre opengleinfuehrung-Anwendung besteht.


opengleinfuehrung.vcxproj
...
opengleinfuehrung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen opengleinfuehrung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
