...
#define NUM_TEXTURES 6           //Anzahl der Texturen
...
float fRotation = 315; //Wert für Schaukel Schwingung
...
bool textureLoaded = true; //lädt Farben anstatt der Texturen für Objekte, falls etwas beim Laden schief geht
...
void Zylinder(GLfloat relativ){
	...
	//Benötigt für das Zeichnen der Seile
	glBegin(GL_POLYGON);
...
void Geruest(GLfloat relativ){
	...
	//Zeichne Hauptstamm und Querstamm
	glEnable(GL_TEXTURE_2D);              //Textur-Mapping anschalten
